...
//        }
        ...
        $this->alipayrsaPublicKey = 'alipayrsaPublicKey';     // 公钥
        $this->appCertSN          = 'appCertSN';              // 调用getCertSN获取证书序列号
        $this->alipayRootCertSN   = 'alipayRootCertSN';       // 调用getRootCertSN获取支付宝根证书序列号
    }
